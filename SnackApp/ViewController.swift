...
//  SnackApp
//
//  Created by kakeru kurosawa on 2018/07/28.
...
class ViewController: UIViewController, UISearchBarDelegate, UITableViewDataSource {
    ...
    func searchOkashi(keyword: String) {
        ...
        //リクエストURLの組み立て
        guard let req_url = URL(string: "http://www.sysbird.jp/webapi/?apikey=guest&keyword=\(keyword_encode)%E3%82%AB%E3%83%AC%E3%83%BC%E5%91%B3&format=json&max=10") else {
        return
    }
        print(req_url)
